...
public class BroomDustParticle extends SpriteBillboardParticle {
    ...
    BroomDustParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            BroomDustParticle gustDustParticle = new BroomDustParticle(clientWorld, d, e, f, g, h, i);
